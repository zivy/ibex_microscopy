...
To contribute your knowledge, read on.
...
> :warning: Do not edit the **roadmap.md** or **publications.md** files, they are automatically generated from the *roadmap.csv* and *publications.bib* files respectively.

#### Adding new information to the *roadmap.csv* file:
...
#### Adding information to existing line in the *roadmap.csv* file:
