...
into the main branch (see .github/workflows/bib2md.yml).
"""
...
def bibfile2md(bib_file, citation_style_language_file, output_file):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        args = [
            ...
            "-t",
            "markdown_strict",
            # "--citeproc", # Parameter for newer versions of pandoc, older version uses separate pandoc-citeproc filter
            "--filter",
            "pandoc-citeproc",
            "--biblatex",
